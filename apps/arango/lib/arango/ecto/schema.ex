defmodule Arango.Ecto.Repo.Schema do
  ...
  def prepare_changeset_for_update(repo, %Changeset{valid?: true} = changeset, opts) do
    ...
    # On update, we always merge the whole struct into the
    # changeset as changes, except the primary key if it is nil.
    ...
    {changes, autogen} =
      dump_changes!(:update, Map.take(changes, fields), schema, extra, dumper, adapter)
  ...
  def prepare_changeset_for_update(repo, %Changeset{valid?: false} = changeset, opts) do
